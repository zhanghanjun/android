...
this.indicatorStyle.height=this.height+"px",b=this.maxPosY+this.indicatorHeight-this.height):b=this.maxBoundaryY:"scale"==this.options.shrink&&this.height!=this.indicatorHeight&&(this.height=this.indicatorHeight,this.indicatorStyle.height=this.height+"px")),this.x=a,this.y=b,this.scroller.options.useTransform?this.indicatorStyle[h.style.transform]="translate("+a+"px,"+b+"px)"+this.scroller.translateZ:(this.indicatorStyle.left=a+"px",this.indicatorStyle.top=b+"px")},_pos:function(a,b){a<0?a=0:a>this.maxPosX&&(a=this.maxPosX),b<0?b=0:b>this.maxPosY&&(b=this.maxPosY),a=this.options.listenX?c.round(a/this.sizeRatioX):this.scroller.x,b=this.options.listenY?c.round(b/this.sizeRatioY):this.scroller.y,this.scroller.scrollTo(a,b)},fade:function(a,b){if(!b||this.visible){clearTimeout(this.fadeTimeout),this.fadeTimeout=null;var c=a?250:500,d=a?0:300;a=a?"1":"0",this.wrapperStyle[h.style.transitionDuration]=c+"ms",this.fadeTimeout=setTimeout(function(a){this.wrapperStyle.opacity=a,this.visible=+a}.bind(this,a),d)}}},d.utils=h,"undefined"!=typeof module&&module.exports?module.exports=d:"function"==typeof define&&define.amd?define(function(){return d}):a.IScroll=d}(window,document,Math),_dateTimeComponentCount=0;var DateTime=function(a,b){var c,d,e,f={},g=a,h=b||DateTime.defaultOpts,i=[],j=["time","date","datetime","diy"],k={y:"年",m:"月",d:"日",h:"时",i:"分",s:"秒"},l=!1,m={_y:function(a){return a.getFullYear()},_m:function(a){return a.getMonth()},_rm:function(a){return a.getMonth()+1},_d:function(a){return a.getDate()},_h:function(a){return a.getHours()},_i:function(a){return a.getMinutes()},_s:function(a){return a.getSeconds()}},n=function(){return _dateTimeComponentCount++},o=function(a,b){var c=!1;return a.forEach(function(a){a===b&&(c=!0)}),c},p=function(a,b){var c=0,d=b?b.toString():"";return a.forEach(function(a,b){d==a.toString()&&(c=b)}),c},q=function(a,b){for(var c=[],d=a;b>=d;d++)c.push(d);return c},r=function(a){return 0-40*a},s=function(a){var b=document.createElement("div");return b.innerHTML=a,!!b.firstChild&&b.firstChild},t=function(a){return{h:m._h(a),i:m._i(a),s:m._s(a),hasSecond:!1}},u=function(){var a=t(h.date);i=a.hasSecond?["h","i","s"]:["h","i"],i.forEach(function(b){var c;"h"==b?c=q(0,23):"i"!=b&&"s"!=b||(c=q(0,59)),f[b]={top:r(a[b]-0),value:a[b],index:p(c,a[b]),list:[],map:c}})},v=function(){var a=h,b=a.minDate.getFullYear(),c=a.maxDate.getFullYear(),d=D(a.date)?a.date:e,g={y:m._y(d),m:m._m(d),rm:m._rm(d),d:m._d(d),h:m._h(d),i:m._i(d),s:m._s(d)};i=["y","m","d","h","i"],f.monthDay=32-new Date(g.y,g.m,32).getDate(),f.y={top:r(g.y-b),value:g.y,ov:g.y,st:b,et:c,list:[],map:q(b,c)},f.m={top:r(g.rm-1),value:g.m,ov:g.m,rv:g.rm,orv:g.rm,st:1,et:12,list:[],map:q(1,12)},f.d={top:r(g.d-1),value:g.d,ov:g.d,st:1,et:31,list:[],map:q(1,31)},i.forEach(function(a){var b;if("h"==a)b=q(0,23);else{if("i"!=a&&"s"!=a)return;b=q(0,59)}f[a]={top:r(g[a]-0),value:g[a],index:p(b,g[a]),list:[],map:b}})},w=function(){var a=h,b=a.minDate.getFullYear(),c=a.maxDate.getFullYear(),d=D(a.date)?a.date:e,g={y:m._y(d),m:m._m(d),rm:m._rm(d),d:m._d(d),h:m._h(d),i:m._i(d),s:m._s(d)};i=["y","m","d"],f.monthDay=32-new Date(g.y,g.m,32).getDate(),f.y={top:r(g.y-b),value:g.y,ov:g.y,st:b,et:c,list:[],map:q(b,c)},f.m={top:r(g.rm-1),value:g.m,ov:g.m,rv:g.rm,orv:g.rm,st:1,et:12,list:[],map:q(1,12)},f.d={top:r(g.d-1),value:g.d,ov:g.d,st:1,et:31,list:[],map:q(1,31)}},x=function(){var a=h;if(a.data.length){var b=a.data;i.length=0,b.forEach(function(a){f[a.key]={key:a.key,value:a.value,index:0,oIndex:0,et:a.resource.length-1,ul:"",list:[],map:a.resource};var b=p(a.resource,a.value);f[a.key].index=b,f[a.key].top=r(b),k[a.key]=a.unit,i.push(a.key)})}},y=function(){var a=h.type;switch(console.log("init type-->",h.type),a){case"date":w();break;case"time":u();break;case"diy":x();break;case"datetime":v()}},z=function(a,b,c,d){var e=a.map,g=p(a.map,b),h=e.length;d.innerHTML="";for(var i="",j=k[c],l=0;2>l;l++)d.appendChild(s("<li></li>"));for(f[c].list.length=0,l=0;l<h;l++){i=g===l?'<li class="selected">'+e[l]+" "+j+"</li>":"<li>"+e[l]+" "+j+"</li>";var m=s(i);f[c].list.push(m),d.appendChild(m)}return f[c].lihook=s("<li></li>"),d.appendChild(f[c].lihook),d.appendChild(s("<li></li>")),d},A=function(){var a=s('<div class="ui-datetime-wrap" style="height: '+d+'px;"></div>'),b=(d/40-1)/2*40,e=s('<div class="ui-datetime-line" style="top: '+b+'px;"></div>');a.appendChild(e);var h=window.screen.width,j=h/i.length;j<104?j-=.3*j:j=80;var k=function(a,b,e){var f=s('<div id="ui-datetime-'+c+"-ad-"+e+'" class="ui-datetime-item" style="height:'+d+'px"></div>'),g=s('<ul style="width: '+j+'px" class="xs-content"></ul>');return z(a,b,e,g),a.ul=g,f.appendChild(g),f};i.forEach(function(b){var c,d=f[b];c="m"==b?k(d,d.rv,b):k(d,d.value,b),a.appendChild(c)}),g.innerHTML="",g.appendChild(a)},B=function(){i.forEach(function(a){if(f[a]){var b=new IScroll("#ui-datetime-"+c+"-ad-"+a,{bounceEasing:"ease",bounceTime:600});b.scrollToIng=!0,b.scrollTo(0,f[a].top,0,IScroll.utils.ease.circular),b.on("scrollEnd",function(){var b=this.y,c=Math.round(b/40);f[a].top!=b&&(f[a].top=40*c,K(a),J(),h.onChange&&"function"==typeof h.onChange&&setTimeout(function(){var a=I();h.onChange(a)},0))}),f[a].xscroll=b}})},C=function(a,b){var c=this;if(c.m){if(b>a)for(var d=a;b>d;d++)c.d.ul.insertBefore(c.d.list[d],c.d.lihook);else if(a>b)for(var e=a;e>b;e--)c.d.list[e-1].remove();c.monthDay=b}},D=function(a){return!!("object"==typeof a&&a instanceof Date)},E=function(a){function b(a){a=a.split(" ");var b=a[0].split("-"),c=a[1].split(":");return{y:parseInt(b[0]),m:parseInt(b[1])-1,rm:parseInt(b[1]),d:parseInt(b[2]),h:parseInt(c[0]),i:parseInt(c[1]),s:parseInt(c[2])}}function c(a){e=new Date;try{a=a.split(":");var b=!!a[2],c=parseInt(a[0],10),d=parseInt(a[1],10),f=0;return b&&(f=parseInt(a[2],10),f=f>=0&&60>f?f:sec(S)),c=c>=0&&24>c?c:hour(S),d=d>=0&&60>d?d:minu(S),{h:c,i:d,s:f,hasSecond:b}}catch(a){return{h:m._h(e),i:m._i(e),s:m._s(e),hasSecond:!1}}}if("diy"!=h.type){var d=1;if(a){if(D(a))d=2;else if("string"==typeof a)if(d=3,"date"==h.type)var g=b(a);else var g=c(a)}else{var j=F();d=1}i.forEach(function(b){if(f[b]){var c=f[b];c.ov=c.value,"m"===b&&(c.orv=c.rv),1===d?(c.value=j[b],"m"===b?(c.rv=j.m,c.index=p(c.map,c.rv),c.top=r(c.index)):(c.index=p(c.map,c.value),c.top=r(c.index))):2===d?(c.value=m["_"+b],"m"==b?(c.rv=m._rm(a),c.index=p(c.map,c.rv),c.top=r(c.index)):(c.index=p(c.map,c.value),c.top=r(c.index))):3===d&&(c.value=g[b],"m"==b?(c.rv=g.rm,c.index=p(c.map,c.rv),c.top=r(c.index)):(c.index=p(c.map,c.value),c.top=r(c.index)))}}),J(),G()}},F=function(){var a={};return i.forEach(function(b){if(f[b]){var c=f[b].top,d=f[b].map[Math.abs(c)/40];a[b]=d,"m"===b&&(a.rm=p(f[b].map,d))}}),a},G=function(){var a=0;if(i.forEach(function(b){if(f[b]){var c,d=f[b];c=r("m"===b?p(d.map,d.rv):p(d.map,d.value)),"d"===b&&(a=c),d.xscroll.scrollToIng=!0,d.xscroll.scrollTo(0,c,300,IScroll.utils.ease.circular)}}),f.m){var b=new Date;b.setYear(f.y.value),b.setMonth(f.m.rv),b.setDate(0);var c=b.getDate(),d=f.d;f.monthDay!==c?(C(f.monthDay,c),d.xscroll.refresh(),d.scrollToIng=!0,d.xscroll.scrollTo(0,a,300,IScroll.utils.ease.circular)):(d.scrollToIng=!0,d.xscroll.scrollTo(0,a,300,IScroll.utils.ease.circular))}},H=function(a){a||(a=F()),i.forEach(function(b){if(f[b]&&0!==a[b]){var c=f[b];c.ov=f[b].value,c.value=a[b],c.index=p(f[b].map,c.value),c.oIndex=p(f[b].map,c.ov),c.top=r(c.index)}}),J(),G()},I=function(){var a={};return i.forEach(function(b){f[b]&&(a[b]=f[b].value,"m"===b&&(a.rm=f[b].rv))}),a},J=function(){i.forEach(function(a){if(f[a]){var b,c,d=f[a];"m"===a?(b=p(d.map,d.orv),c=p(d.map,d.rv)):(b=p(d.map,d.ov),c=p(d.map,d.value)),b!=c&&(d.list[b].className="",d.list[c].className="selected")}})},K=function(a){if(!f.m&&!f.h)return void H();if(E(),"d"!=a&&f.m){var b=new Date;b.setYear(f.y.value),b.setMonth(f.m.rv),b.setDate(0);var c=b.getDate();f.monthDay!==c&&C(f.monthDay,c),f.d.xscroll.refresh()}};return f.init=function(){return c=n(),d=h.height||"200",(l=o(j,h.type))?(y(),A(),void B()):void console.error("unSupport type!")},f.show=function(){g&&(g.style.display="block")},f.hide=function(){g&&(g.style.display="none")},f.bindEvent=B,f};DateTime.defaultOpts={type:"date",date:new Date,minDate:new Date,maxDate:new Date,gap:!1,demotion:!1,data:[{key:"day",resource:["上午","下午"],value:"上午",unit:""},{key:"hour",resource:["21","22","23","01","02","03","04","05","06","07"],value:"22",unit:""},{key:"minute",resource:["00","30"],value:"00",unit:""}],onChange:function(a){console.log("call back",a)}},function(a){a&&(a.fn.datetime=function(b){return this.each(function(){var c=a(this),d=c.data("datetime"),e="object"==typeof b&&b;d||(d=new DateTime(this,e),d.init(),c.data("datatime",d)),"string"==typeof b&&d[b]()})})}(Window.Zepto||window.jQuery);