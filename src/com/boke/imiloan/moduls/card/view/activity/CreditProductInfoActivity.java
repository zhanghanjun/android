...
package com.boke.imiloan.moduls.card.view.activity;
 ...
 * 信用卡详情页面
 */
public class CreditProductInfoActivity extends CordovaActivity
{
    private static final String TAG = CreditProductInfoActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_credit_product_info);
        loadData(false);
    }
    ...
    private void initView() {
        systemWebView  = (SystemWebView)findViewById(R.id.credit_pro_info_webview);
        ...
        String url = "file:///android_asset/www/99998/www/index.html#/cardApply";
        ...
        systemWebView.setWebViewClient(new SystemWebViewClient((SystemWebViewEngine) cordovaWebView.getEngine()){
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                LoadingDialog.getInstance().showDialog(CreditProductInfoActivity.this,getResources().getString(R.string.common_loading_msg));
            }
    ...
    public void callBackCreditProductInfo(CreditProductInfoBean result){
        LogUtil.e("creditinfo==",new Gson().toJson(result));
        if(result!=null){
