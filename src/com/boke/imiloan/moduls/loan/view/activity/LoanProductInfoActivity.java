...
package com.boke.imiloan.moduls.loan.view.activity;
 ...
 * 信用卡详情页面
 */
public class LoanProductInfoActivity extends CordovaActivity
{
    private static final String TAG = LoanProductInfoActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_loan_product_info);
        loadData(false);
    }
    ...
    private void initView() {
        systemWebView  = (SystemWebView)findViewById(R.id.loan_pro_info_webview);
        ...
        String url = "file:///android_asset/www/99998/www/index.html#/productDetail";
        ...
        systemWebView.setWebViewClient(new SystemWebViewClient((SystemWebViewEngine) cordovaWebView.getEngine()){
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                LoadingDialog.getInstance().showDialog(LoanProductInfoActivity.this,getResources().getString(R.string.common_loading_msg));
            }
    ...
    public void callBackLoanProductInfo(LoanProductInfoBean result){
        LogUtil.e("loaninfo==",new Gson().toJson(result));
        if(result!=null){
