package com.boke.imiloan.moduls.loan.view.fragment;
...
public class LoanFragment extends BaseFragment{
    ...
    private void initView(View contentView) {
        systemWebView  = (SystemWebView)contentView.findViewById(R.id.loan_webview);
        ...
        cordovaWebView.loadUrl("file:///android_asset/www/99998/www/index.html#/productList");
