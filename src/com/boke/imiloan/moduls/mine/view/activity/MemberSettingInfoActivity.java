...
import com.boke.imiloan.bean.MemberSettingInfoBean;
 ...
 * 我的-设置页面
 */
public class MemberSettingInfoActivity extends CordovaActivity
{
    private static final String TAG = MemberSettingInfoActivity.class.getSimpleName();
    ...
    private void initView() {
        systemWebView  = (SystemWebView)findViewById(R.id.user_membersetting_webview);
        ...
        String url = "file:///android_asset/www/99998/www/index.html#/set";
        ...
        systemWebView.setWebViewClient(new SystemWebViewClient((SystemWebViewEngine) cordovaWebView.getEngine()){
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                LoadingDialog.getInstance().showDialog(MemberSettingInfoActivity.this,getResources().getString(R.string.common_loading_msg));
            }
    ...
    public void callBackMemberSettingInfo(MemberSettingInfoBean result){
        LogUtil.e("MemberSettingInfoBean==",new Gson().toJson(result));
        if(result!=null){
