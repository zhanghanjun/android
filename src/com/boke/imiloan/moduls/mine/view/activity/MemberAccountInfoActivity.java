 ...
 * 我的-账号信息页面
 */
public class MemberAccountInfoActivity extends CordovaActivity
{
    private static final String TAG = MemberAccountInfoActivity.class.getSimpleName();
    ...
    private void initView() {
        systemWebView  = (SystemWebView)findViewById(R.id.user_memberaccount_webview);
        ...
        String url = "file:///android_asset/www/99998/www/index.html#/countMsg";
        ...
        systemWebView.setWebViewClient(new SystemWebViewClient((SystemWebViewEngine) cordovaWebView.getEngine()){
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                LoadingDialog.getInstance().showDialog(MemberAccountInfoActivity.this,getResources().getString(R.string.common_loading_msg));
            }
    ...
    public void callBackMemberAccountInfo(MemberAccountInfoBean result){
        LogUtil.e("MemberAccountInfoBean==",new Gson().toJson(result));
        if(result!=null){
