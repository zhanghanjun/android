...
public class LoginActivity extends CordovaActivity
{
    ...
    private void initView() {
        systemWebView  = (SystemWebView)findViewById(R.id.user_login_webview);
        ...
        String url = "file:///android_asset/www/99998/www/index.html#/loginp";
        ...
        systemWebView.setWebViewClient(new SystemWebViewClient((SystemWebViewEngine) cordovaWebView.getEngine()){
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                LoadingDialog.getInstance().showDialog(LoginActivity.this,getResources().getString(R.string.common_loading_msg));
            }
    ...
    public void callBackMemLogin(UserBean userBean){
        if(userBean!=null){
            LogUtil.e("==userBean==",new Gson().toJson(userBean));
            LogUtil.e("==token==",userBean.getData().getToken());
            ToastUtil.showToast(this,userBean.getMessage());
            if(StringUtils.isEqual(userBean.getErrorCode(),"0")){
