 ...
 * 用户注册页面
 */
public class RegisterActivity extends CordovaActivity
{
    ...
    private void initView() {
        systemWebView  = (SystemWebView)findViewById(R.id.user_register_webview);
        ...
        String url = "file:///android_asset/www/99998/www/index.html#/registerp";
        ...
        systemWebView.setWebViewClient(new SystemWebViewClient((SystemWebViewEngine) cordovaWebView.getEngine()){
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                LoadingDialog.getInstance().showDialog(RegisterActivity.this,getResources().getString(R.string.common_loading_msg));
            }
    ...
    public void callBackMemRregister(UserRegisterBean result){
        if(result!=null){
    ...
    public void callBackMemRegisterSubmit(UserRegisterSubmitBean result){
        if(result!=null){
            ToastUtil.showToast(this,result.getMessage());
        }else{
            ToastUtil.showToast(this,"系统维护中，请稍后再试");
